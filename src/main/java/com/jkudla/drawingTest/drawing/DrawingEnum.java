...
import com.jkudla.drawingTest.drawing.bucket.Bucket;
import com.jkudla.drawingTest.drawing.bucket.BucketValidator;
...
public enum DrawingEnum {
    ...
    BUCKET("B", new Bucket(), new BucketValidator());
